...
const PUBLISHABLE_API_KEY = env.NEXT_PUBLIC_MEDUSA_PUBLISHABLE_KEY
const DEFAULT_REGION = env.NEXT_PUBLIC_DEFAULT_REGION
...
export async function proxy(request: NextRequest) {
  ...
  const urlHasCountryCode = countryCode && url.includes(countryCode)
